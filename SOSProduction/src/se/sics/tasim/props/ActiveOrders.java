 ...
 * Updated : $Date: 2005/06/03 15:13:51 $
 *           $Revision: 1.7 $
 */
 ...
 *
 * Active orders are sent by the server when an agent connects to an
 * already running game/simulation.
 *
...
public class ActiveOrders implements Transportable, java.io.Serializable {
   ...
   *
   * @param index the index of the customer order
   ...
   *
   * @param index the index of the supplier order
